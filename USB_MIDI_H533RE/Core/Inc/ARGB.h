...
// WS2811S — RGB, 400kHz;
// WS2811F — RGB, 800kHz;
// WS2812  — GRB, 800kHz; // SK6812 Mini-E uses GRB order
// SK6812  — RGBW, 800kHz

#define NUM_PIXELS 16 ///< Pixel quantity (Opdracht = 16 leds)

#define USE_GAMMA_CORRECTION 0 ///< Gamma-correction (disabled voor simpele kleuren)

#define TIM_NUM    3  ///< Timer number
#define TIM_CH     TIM_CHANNEL_1  ///< Timer's PWM channel
#define DMA_HANDLE handle_GPDMA1_Channel1  ///< DMA Channel pointer for STM32H5
