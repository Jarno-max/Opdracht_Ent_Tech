...
#define MIDI_CC_POT5  20
#define MIDI_CC_POT6  21
#define MIDI_CC_POT7  22
#define MIDI_CC_POT8  23
/* USER CODE END PD */
...
static uint8_t pot_cc(uint8_t index)
{
  switch (index)
  {
    ...
    case 4: return MIDI_CC_POT5;
    case 5: return MIDI_CC_POT6;
    case 6: return MIDI_CC_POT7;
    case 7: return MIDI_CC_POT8;
    default: return 0;
  }
}
...
int main(void)
{
  ...
  // Initialize SK6812 LED strip and run animation before blocking tasks
#ifdef ENABLE_MATRIX
  sk6812_init();
  sk6812_startup_animation();
#endif
